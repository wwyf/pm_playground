...
const uint64_t block_size = 128*1024; // 128KB
const uint64_t count = 8*1024 * 8; 
...
int main(){
    ...
    std::cout << "io_size(Bytes),write_avg_latency,throughput,bandwidth(MB)" << std::endl;
